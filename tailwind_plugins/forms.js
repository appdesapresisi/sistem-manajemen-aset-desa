...
module.exports = plugin(function ({ addComponents, theme }) {
  addComponents({
    ...
    '.typeahead': {
      '@apply relative': {},
      '&>ul': {
        '@apply absolute top-full float-left left-0 m-[2px_0_0] p-[5px_0] min-w-[170px] shadow-[0_6px_12px_rgba(0,0,0,.17)] rounded border border-theme-border dark:border-themedark-border bg-theme-cardbg dark:bg-themedark-cardbg':
          {},
        '&>li': {
          '>a': {
